        ...
        if (uploadType != null && !uploadType.isEmpty()) {
            if ("1".equals(uploadType)) {
                ...
                rules.add(formBuilder.frameImage(menuName, info,
                    "admin/#/admin/widget.images/index?fodder=" + menuName, valueStr)
                    .icon("ios-image")
                    .width("950px")
                    .height("420px")
                    .col(13));
                ...
                // 文件上传
                rules.add(formBuilder.frameImage(menuName, info,
                    "admin/#/admin/widget.files/index?fodder=" + menuName, valueStr)
                    .icon("ios-folder")
                    .width("950px")
                    .height("420px")
                    .col(13));
        ...
        if (uploadType != null && !uploadType.isEmpty()) {
            if ("1".equals(uploadType)) {
                ...
                rules.add(formBuilder.frameImage("value", "Default Value",
                    "admin/#/admin/widget.images/index?fodder=value", valueStr)
                    .icon("ios-image")
                    .width("960px")
                    .height("505px"));
            } else if ("2".equals(uploadType)) {
                ...
                rules.add(formBuilder.frameImage("value", "Default Value",
                    "admin/#/admin/widget.files/index?fodder=value", valueStr)
                    .icon("ios-folder")
                    .width("960px")
                    .height("505px"));
            }
