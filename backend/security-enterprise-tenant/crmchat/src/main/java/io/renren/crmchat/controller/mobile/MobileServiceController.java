...
public class MobileServiceController {
    ...
    public ApiResult<Map<String, Object>> getRecordList(@RequestParam Map<String, String> params) {
       ...
       /* Long jwtUserId = UserContext.getUserId();
        if (jwtUserId != null && jwtUserId > 0) {
            ...
            log.info("[Guest history] Extracted userId from JWT: {}, appid: {}", jwtUserId, appid);
        }*/

        // 调试日志：检查租户隔离
        log.info("[Tenant isolation] Controller layer - original params: {}, extracted appid: {}", params, appid);
    ...
    @Operation(summary = "Set cache data")
    ...
    @Operation(summary = "Guest auto-login")
    ...
    @Operation(summary = "Get agent icon configuration")
    ...
    @Operation(summary = "Get message send ID")
