<template>
    <div class="content">
        ...
        <p class="text-i">{{ $t('system.hyperlinkDescription') }}</p>
        <p class="font-w">{{ $t('system.hyperlinkParameters') }}</p>
                <p class="text-i">
                    <br>{{ $t('system.paramToken') }}
                    <br>{{ $t('system.paramNoCanClose') }}
                <br>{{ $t('system.paramDeviceType') }}
                <br>{{ $t('system.paramUid') }}
                <br>{{ $t('system.paramNickName') }}
                <br>{{ $t('system.paramPhone') }}
                <br>{{ $t('system.paramSex') }}
                <br>{{ $t('system.paramAvatar') }}
                <br>{{ $t('system.paramOpenid') }}
                <br>{{ $t('system.paramKefuId') }}
                </p>
        <Divider />
        <p class="typetitle">{{ $t('system.autoRecognizeBrowser') }}</p>

        <div class="fenlei">
            <div class="code-content-wrap">
        <textarea id="NormalCodeTextarealink1" class="code" rows="1">{{tokeninfo.path}}/#/chat/index?noCanClose=1&token={{tokeninfo.tokenMd5}}</textarea>
        ...
        <div  class="fenlei">
            <div class="code-content-wrap">
        <textarea id="NormalCodeTextarealink2" class="code" rows="1">{{tokeninfo.path}}/#/chat/pc?noCanClose=1&token={{tokeninfo.tokenMd5}}</textarea>
                <div class="other-wrap">
        ...
        <div  class="fenlei">
            <div class="code-content-wrap">
        <textarea id="NormalCodeTextarealink3" class="code" rows="1">{{tokeninfo.path}}/#/chat/mobile?noCanClose=1&token={{tokeninfo.tokenMd5}}</textarea>
            <div class="other-wrap">
