...
export default{
    ...
    computed: {
        linkUrl1() {
            return `${location.origin}/admin/#/chat/index?token=${this.tokeninfo.tokenMd5}&noCanClose=1`;
        },
        linkUrl2() {
            return `${location.origin}/admin/#/chat/index?token=${this.tokeninfo.tokenMd5}&noCanClose=1&deviceType=Mobile`;
        },
        linkUrl3() {
            return `${location.origin}/admin/#/chat/index?token=${this.tokeninfo.tokenMd5}&noCanClose=1`;
        }
